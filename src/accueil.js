...
export default function Accueil() {
  ...
  return <>
      ...
      <div className='accueil'>
          <div className="scrollItems" style={{minWidth:'96%',justifyContent:'center',width:"96%",display:'flex',background:'linear-gradient(to left top, white,rgba(0,90,90,0.8))',flexDirection:'row',gap:'2%',marginTop:'-4rem',padding:'0px 2%',paddingBottom:'2rem',}}>
