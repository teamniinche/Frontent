    ...
    <div style={{paddingTop:"20px",display:"flex",flexFlow:"row wrap",alignItems:"start",justifyContent:"space-around"}}>
      {
        ...
        <div style={{position:"relative",width:"44vw",height:"50vw",padding:"2vw",margin:"0.40vw",borderRadius:"4px",border:"1px solid grey"}}>
            <img src={cloudinaryBaseUrl+'/'+ image.imgName} alt='Delagalerie' style={{position:"absolute",zIndex:"0",bottom:"0px",width:"44vw",height:"44vw",margin:"0px",padding:"0px"}}/>
            <div style={{position:"absolute",float:"left",zIndex:"1",display:"flex",flexFlow:"row wrap",width:"100%",height:"4vw"}}>
