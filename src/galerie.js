...
export default function Galerie() {
  ...
  return <>
    <div style={{position:"relative",width:"95vw",marginTop:"100px",padding:"1em 2.5vw",borderBottom:"3px solid rgb(240,240,240)"}}>
       <div style={{position:"absolute",margin:"0px",padding:"0px",width:"100%",height:"100%",zIndex:"0",display:"flex",flexDirection:"row",justifyContent:"space-around"}}>
        ...
        <div id="overlay-div" style={{position:"absolute",display:"inline-block",margin:"0px",padding:"0px",width:"100%",height:"100%",float:"left",zIndex:"1",backgroundColor:"rgba(0,0,0,0.06)"}}>'</div>
    </div>
    <Outlet/>
    <div>
