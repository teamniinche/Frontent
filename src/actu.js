...
{/*</div>*/}
  ...
  export function DerniereActualite(){
    ...
    return <>
      <h3 id="1" style={{margin:"0px",marginTop:"1em",borderTop:"1px double brown",padding:".5em 1em",borderTopRightRadius:"8px",fontWeight:"bold",borderBottomRightRadius:"8px",fontSize:"0.8rem",textDecoration:"none",border:"1px solid rgba(0,145,0,0.9)",borderLeft:"0.5rem solid rgba(0,145,0,0.9)",textAlign:"center",color:"rgba(0,145,0,0.9)",}}><a href="#tec" style={{color:"rgba(255,0,0,.4)",letterSpacing: "4px",textDecoration:"none" }}>{">> "}A propos de la team & des Niintches...</a></h3>
