...
export default function Mur() {
  ...
  <h4 style={{lineHeight:"1rem",display:"inlline-block",width:"100%",color:"rgba(255,255,255,0.5",fontFamily:"sans-serif",fontSize:"1rem",position:"absolute",top:"50%",textAlign:"center",}}>
